    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-offset-3 col-md-6">
                ...
                $result = mysqli_query($conn, $sql) or die("Query failed in line 12 settting.php");
                ...
                ?>
                        ...
                        <form action="save-settings.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="footer_desc" class="form-control" rows="5" required><?php echo $row['footer'] ?></textarea>
                            </div>
